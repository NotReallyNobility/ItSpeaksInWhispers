...
public class Main {
    ...
    //Many choices in this game are made using a String array. 
    //This presents the options numerically and makes sure they enter a valid option.
    //It then returns the inputted number - 1, providing the index for the choice.
    public static int getChoice(String[] list, Scanner temp) {
        boolean hidden = false;
        printOptions(list, hidden);
        int choice = temp.nextInt() - 1;
        while (choice < 0 || choice > (list.length - 1)) { 
                System.out.println("Please, pick a proper choice.");
                
                choice = temp.nextInt() - 1;
        }
    ...
    public static int getChoice(String[] list, Scanner temp, boolean hidden) {
        printOptions(list, hidden);
        /*int i = 1;
    ...
    public static void printOptions(String[] list, boolean hidden) {
        int i = 1;
        for (String listItem : list) {
                if (i < list.length - 1) {
                    System.out.println(i + ": " + listItem);
    ...
    //prints the condition of the character.
    public static void printCondition(boolean hungry, boolean thirsty, boolean injured) {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Let's start with a simple one. Enter your character's name: ");
        String name = in.nextLine();
        System.out.println("Lovely.\n");
        

        //Allows choice of gender
        String[] proSubj = {"he", "she", "they"};
        String[] proObj = {"him", "her", "them"};
        String[] proPossAdj = {"his", "hers", "theirs"};
        ...
        int genderChoice = getChoice(genderList, in);
        ...
        System.out.print("Now one last question. Enter your character's age: ");
        int age = in.nextInt();
        if (age < 25) {
        ...
        System.out.println(name + " set out at dawn, " + proPossAdj[genderChoice] + " pack light and hopes high.");
        if (age < 50) {
                System.out.print("At only " + age + " years old, " + proSubj[genderChoice] + " already carries stories that most would never dare to tell.");
        } else if (age < 100) {
                System.out.print("At a ripe age of " + age + ", " + proSubj[genderChoice] + " carries stories that most would never dare tell.");
        } else {
                System.out.print("At an ancient " + age + " years old, " + proSubj[genderChoice] + "'d lived tales you can't even imagine.");
        }
        System.out.println(" How lucky for you to glimpse into this one.");
        System.out.println("In the pouch at " + proPossAdj[genderChoice] + " side clinked " + gold + " gold coins— "
                + "not much, but enough for bread and a bed in a quiet inn. One can only sleep in a tent so many days in a row.");
        System.out.println("A weathered sign pointed toward the Whispering Woods, and " + proSubj[genderChoice]
                + " felt a shiver that had nothing to do with the cold.");
        System.out.println("Whatever waited beyond the treeline would test " + proObj[genderChoice] + ", but " + name
        ...
        System.out.println("The Whispering Woods are a place " + name + " had heard of before.");
        ...
        int myNameChoice = getChoice(myNames, in, true);
        ...
        switch (myNameChoice) {
            ...
            case 2:
                ...
                System.out.println("It's eyes were hollow. It had ridged two horns going back and slightly out, each forming a semi circle. The shape was entirely inhuman, almost a mix between a deer and a bird is how it's often described, though how this may appear is unknown to " + name + ".");
                break;
        ...
        System.out.print("Just how many millenia old do you think it is?: ");
        int myAge = in.nextInt();
        System.out.println((myAge * 1000) + " years old... I would have said older.");
        System.out.println("As " + name + " made " + proObj[genderChoice] + " way to the woods remembering all those tales of " + myNames[myNameChoice] + ", " + proSubj[genderChoice] + " couldn't help but recall one of them more clearly than the others.\n");
        
        System.out.println("Once, long, long ago before the forest even had a name, a town was forming. A town that took the name...");
        System.out.print("Hmm, what was it's name again?: ");
        ...
        System.out.print("Fancy a guess as to how many hunters went mad in the first ten years?: ");
        ...
        System.out.println(name + " thought on this tale for a while, fear overcoming " + proObj[genderChoice] + " sense. The chill became a shiver.");
        System.out.println(proSubj[genderChoice] + " needed to take " + proPossAdj[genderChoice] + "mind off this, to focus on something else. 'The road. Look at the road'");
        ...
        System.out.println("Most discount such things existing, but not " + name + ". " + proSubj[genderChoice] + "'s seen too many supernatural beasts. Honestly they've become something of an enjoyable nuisance");
        System.out.print("It's to the point he lost track in fact. What was it, somewhere near 15 or 20?: ");
        ...
        System.out.println("\nRegardless, " + name + " collected the coins and continued on, pleased to see the coins."
        ...
        System.out.print("Was it a flower or a fox?: ");
        String[] sachelPattern = {"flower", "fox"};
        int sachelChoice = getChoice(sachelPattern, in);

        System.out.println("Of course. Everyone loves a good " + sachelPattern[sachelChoice] + ". " + name + "'ll have to check at one of the upcoming taverns if anyone lost it.");
        ...
        System.out.println(name + " took a moment to reflect on " + proObj[genderChoice] + " condition.");
        printCondition(hungry, thirsty, injured);
        System.out.print("Which tavern would you like to visit, The Slumbering Mound, The Tortured Hog, or The Overflowed Mug? (Mound/Hog/Mug):");
        ...
        int tavernChoice = getChoice(taverns, in);
        ...
        switch (tavernChoice) {
           case 0:
                drinkPrice = 2;
                foodPrice = 2;
                System.out.println("The Slumbering Mound, named for it's drowsy appearance. As " + name +" stepped into the establishment, nary a customer could be seen.");
           case 1:
                drinkPrice = 1;
                foodPrice = 3;
        ...
        switch (tavernChoice) {
           case 0:
                System.out.println("The barkeek was a short man, with whispy hair and an equally whispy beard too. Somehow he had bags under his eyes despite the fact " + name + "'s appearance woke them from their nap.");
                System.out.println("'Two coins a drink, 1 for  don't be picky, we ain't got much to choose.' the barkeep spoke through a yawn.");
                System.out.println("Responding with equal enthusiam, " + name + " said, 'Don't worry. My tastes are road worn, I don't need much.'");
           ...
           case 1:
                System.out.println("Before " + name + " could even take a few steps through the door the barkeep shouted out 'Here for some pig? 3 coins. Pint's just a single coin though.'");
                System.out.println("Having a chance to properly get a look, " + name + " could see the barkeep was a strongly built woman in a bloodstained apron. A smirk came to " + name + "'s face.");
           ...
           case 2:
                System.out.println("Walking into the building, a comfortable air hit " + name + "'s face. Clearly this building was better built than most to retain heat in the fall.");
                ...
                System.out.println("A smile on " + name + "'s face, " + proSubj[genderChoice] + " responded, 'Not yet thank you, I'd rather take a moment to enjoy the lack of insects trying to crawl on me anytime I sit down.'");
        ...
        System.out.println("Musing to " + proObj[genderChoice] + "self, " + name + " came to the conclusion, 'I probably could go for something. I have enough coins certainly.'");
        if (hungry) {
                System.out.print("'Should I get some food?' (y/n): ");
                ...
                if (in.next().equals("n")) {
                        ...
                        switch (tavernChoice) {
                           case 0:
                                System.out.println("Walking up to the drowsy man, " + name + " tapped the counter and said 'Barkeep, one meat pie, please.'");
                                ...
                                System.out.println(name + "'s nose wrinkled in disgust. 'Not very fresh I see...'");
                           ...
                           case 1:
                                ...
                                System.out.println("Pleased, " + name + "answered with 'A proper meal in lands like these. I'll dig in right away.'");
                                System.out.println("'A pleasure serving you.'");
                                hungry = false;
                                break;

                           case 2:
                                System.out.println("'Your food is expensive. I'm eager to see if it's worth the price.' " + name + " said with a grin.");
                                System.out.println("'Right away friend, chicken or beef?' '...Chicken.' 'Right away then.'");
                                System.out.println(name + " took their time to enjoy the atmosphere of the place for a moment. The chairs were cushioned, rare in these parts. The floor didn't creek, in fact the door was spotless.");
                                System.out.println("As the tavern owner brought the food, " + name + " couldn't help but ask, 'Out of curiousity, how do you even afford to keep this place this nice? I can't imagine you get much business.'");
        ...
        if (thirsty) {
            System.out.print("'Should I get something to drink?' (y/n): ");
                while (properChoice == false) {
                        if (in.next().equals("y")) {
                                break;
                        } else if (in.next().equals("n")) {
                ...
                if (in.next().equals("n")) {
                        ...
                        switch (tavernChoice) {
                           case 0:
                                System.out.println(name + " went to the counter and said 'Mind if I try the ale?' startling the raggedy coot awake.");
                           ...
                           case 1:
                                System.out.println("'The food here is obviously well made,' " + name + "said with a question in her voice, 'but what of the drink?'");
                                ...
                                System.out.println("Curiosity filling " + proObj[genderChoice] + " mind, " + name + " couldn't help but ask for an expanation as the drink was passed along the table. Just a simple ale, the standard for bars such as this.");
                           ...
                           case 2:
                                System.out.println("'So, you speak highly of your drinks, what do you serve that makes your ale so much better?' " + name + " asked, as an almost smug look took over the establishment's owner.");
                                System.out.println("'The simple answer is, we don't.'");
                                System.out.println("'I beg your pardon?' " + name + " responded, quite a bit taken aback by a frankly outlandish notion in these parts, before recovering " + proPossAdj[genderChoice] + "elf.");
